...
#ifndef FLATBUFFERS_GENERATED_LOBBYSERVERPROTOCOL_PROTOCOL_H_
#define FLATBUFFERS_GENERATED_LOBBYSERVERPROTOCOL_PROTOCOL_H_
...
struct LOBBYSERVER_PROTOCOL;
struct LOBBYSERVER_PROTOCOLBuilder;

enum MESSAGETYPE : int32_t {
  MESSAGETYPE_BEGIN = 0,
  MESSAGETYPE_REQUEST_CONNECT = 1,
  MESSAGETYPE_RESPONSE_CONNECT = 2,
  MESSAGETYPE_NOTICE_ACCOUNT = 3,
  MESSAGETYPE_INVENTORY_SLOT = 4,
  MESSAGETYPE_NOTICE_INVENTORY = 5,
  MESSAGETYPE_NOTICE_INVENTORY_UPDATE = 6,
  MESSAGETYPE_NOTICE_INVENTORY_DELETED = 7,
  MESSAGETYPE_REQUEST_ITEM_BREAK = 8,
  MESSAGETYPE_RESPONSE_ITEM_BREAK = 9,
  MESSAGETYPE_REQUEST_HEARTBEAT = 10,
  MESSAGETYPE_RESPONSE_HEARTBEAT = 11,
  MESSAGETYPE_END = 12,
...
enum MessageContent : uint8_t {
  ...
  MessageContent_NOTICE_ACCOUNT = 3,
  MessageContent_INVENTORY_SLOT = 4,
  MessageContent_NOTICE_INVENTORY = 5,
  MessageContent_NOTICE_INVENTORY_UPDATE = 6,
  MessageContent_NOTICE_INVENTORY_DELETED = 7,
  MessageContent_REQUEST_ITEM_BREAK = 8,
  MessageContent_RESPONSE_ITEM_BREAK = 9,
  MessageContent_REQUEST_HEARTBEAT = 10,
  MessageContent_RESPONSE_HEARTBEAT = 11,
  MessageContent_MIN = MessageContent_NONE,
  MessageContent_MAX = MessageContent_RESPONSE_HEARTBEAT
};

inline const MessageContent (&EnumValuesMessageContent())[12] {
...
struct LOBBYSERVER_PROTOCOL FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef LOBBYSERVER_PROTOCOLBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_MESSAGE_TYPE = 4,
    VT_CONTENT_TYPE = 6,
    VT_CONTENT = 8
...
template<> inline const protocol::REQUEST_CONNECT *LOBBYSERVER_PROTOCOL::content_as<protocol::REQUEST_CONNECT>() const {
  return content_as_REQUEST_CONNECT();
}

template<> inline const protocol::RESPONSE_CONNECT *LOBBYSERVER_PROTOCOL::content_as<protocol::RESPONSE_CONNECT>() const {
  return content_as_RESPONSE_CONNECT();
}

template<> inline const protocol::NOTICE_ACCOUNT *LOBBYSERVER_PROTOCOL::content_as<protocol::NOTICE_ACCOUNT>() const {
  return content_as_NOTICE_ACCOUNT();
}

template<> inline const protocol::INVENTORY_SLOT *LOBBYSERVER_PROTOCOL::content_as<protocol::INVENTORY_SLOT>() const {
  return content_as_INVENTORY_SLOT();
}

template<> inline const protocol::NOTICE_INVENTORY *LOBBYSERVER_PROTOCOL::content_as<protocol::NOTICE_INVENTORY>() const {
  return content_as_NOTICE_INVENTORY();
}

template<> inline const protocol::NOTICE_INVENTORY_UPDATE *LOBBYSERVER_PROTOCOL::content_as<protocol::NOTICE_INVENTORY_UPDATE>() const {
  return content_as_NOTICE_INVENTORY_UPDATE();
}

template<> inline const protocol::NOTICE_INVENTORY_DELETED *LOBBYSERVER_PROTOCOL::content_as<protocol::NOTICE_INVENTORY_DELETED>() const {
  return content_as_NOTICE_INVENTORY_DELETED();
}

template<> inline const protocol::REQUEST_ITEM_BREAK *LOBBYSERVER_PROTOCOL::content_as<protocol::REQUEST_ITEM_BREAK>() const {
  return content_as_REQUEST_ITEM_BREAK();
}

template<> inline const protocol::RESPONSE_ITEM_BREAK *LOBBYSERVER_PROTOCOL::content_as<protocol::RESPONSE_ITEM_BREAK>() const {
  return content_as_RESPONSE_ITEM_BREAK();
}

template<> inline const protocol::REQUEST_HEARTBEAT *LOBBYSERVER_PROTOCOL::content_as<protocol::REQUEST_HEARTBEAT>() const {
  return content_as_REQUEST_HEARTBEAT();
}

template<> inline const protocol::RESPONSE_HEARTBEAT *LOBBYSERVER_PROTOCOL::content_as<protocol::RESPONSE_HEARTBEAT>() const {
  return content_as_RESPONSE_HEARTBEAT();
}

struct LOBBYSERVER_PROTOCOLBuilder {
  typedef LOBBYSERVER_PROTOCOL Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_message_type(protocol::MESSAGETYPE message_type) {
    fbb_.AddElement<int32_t>(LOBBYSERVER_PROTOCOL::VT_MESSAGE_TYPE, static_cast<int32_t>(message_type), 0);
  }
  void add_content_type(protocol::MessageContent content_type) {
    fbb_.AddElement<uint8_t>(LOBBYSERVER_PROTOCOL::VT_CONTENT_TYPE, static_cast<uint8_t>(content_type), 0);
  }
  void add_content(::flatbuffers::Offset<void> content) {
    fbb_.AddOffset(LOBBYSERVER_PROTOCOL::VT_CONTENT, content);
  }
  explicit LOBBYSERVER_PROTOCOLBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<LOBBYSERVER_PROTOCOL> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<LOBBYSERVER_PROTOCOL>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<LOBBYSERVER_PROTOCOL> CreateLOBBYSERVER_PROTOCOL(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  LOBBYSERVER_PROTOCOLBuilder builder_(_fbb);
...
inline const protocol::LOBBYSERVER_PROTOCOL *GetLOBBYSERVER_PROTOCOL(const void *buf) {
  return ::flatbuffers::GetRoot<protocol::LOBBYSERVER_PROTOCOL>(buf);
}

inline const protocol::LOBBYSERVER_PROTOCOL *GetSizePrefixedLOBBYSERVER_PROTOCOL(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<protocol::LOBBYSERVER_PROTOCOL>(buf);
}

inline bool VerifyLOBBYSERVER_PROTOCOLBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<protocol::LOBBYSERVER_PROTOCOL>(nullptr);
}

inline bool VerifySizePrefixedLOBBYSERVER_PROTOCOLBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<protocol::LOBBYSERVER_PROTOCOL>(nullptr);
}

inline void FinishLOBBYSERVER_PROTOCOLBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<protocol::LOBBYSERVER_PROTOCOL> root) {
  fbb.Finish(root);
}

inline void FinishSizePrefixedLOBBYSERVER_PROTOCOLBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<protocol::LOBBYSERVER_PROTOCOL> root) {
...
#endif  // FLATBUFFERS_GENERATED_LOBBYSERVERPROTOCOL_PROTOCOL_H_
